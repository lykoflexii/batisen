...
class EmployeGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Employe entity")
        ...
        .repeat(2) {
            ...
            .post("/api/employes")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "nomEmploye":"SAMPLE_TEXT", "prenomEmploye":"SAMPLE_TEXT", "matricule":"SAMPLE_TEXT", "fonction":"SAMPLE_TEXT", "dateNaissance":"2020-01-01T00:00:00.000Z", "telephoneEmploye":"SAMPLE_TEXT", "salaire":null, "sexe":null}""")).asJSON
            .check(status.is(201))
