...
class ClientGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Client entity")
        ...
        .repeat(2) {
            ...
            .post("/api/clients")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "nomClient":"SAMPLE_TEXT", "villeClient":"SAMPLE_TEXT", "adresseClient":"SAMPLE_TEXT", "telephoneClient":"SAMPLE_TEXT", "fax":"SAMPLE_TEXT", "emailClient":"SAMPLE_TEXT", "typeClient":null, "prenomClient":"SAMPLE_TEXT", "nomCommercial":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
