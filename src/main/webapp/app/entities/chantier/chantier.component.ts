...
currentAccount: any;
    ...
    registerChangeInChantiers() {
        this.eventSubscriber = this.eventManager.subscribe('chantierListModification', (response) =>  this.load(+sessionStorage.getItem('entreprise_id')));
    }
    ...
    load(id: number) {
        this.chantierService.findChantier(id)
            ...
            this.chantierService.findByCurrentUser().subscribe((Response: HttpResponse<Chantier[]>) => {
                this.chantiers = Response.body;
            });
    }
