...
export class ClientDialogComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        //     .subscribe((res: HttpResponse<Entreprise[]>) => { this.entreprises = res.body; }, (res: HttpErrorResponse) => this.onError(res.message));
            // this.entrepriseService.find(+sessionStorage.getItem('entreprise_id'))
            // .subscribe((res: HttpResponse<Entreprise>) => { this.entreprise = res.body; }, (res: HttpErrorResponse) => this.onError(res.message));
    }
    ...
    save() {
        ...
        if (this.client.id !== undefined) {
           ...
           // this.client.entrepriseName = this.entreprise.name;
            this.client.entrepriseId = +sessionStorage.getItem('entreprise_id');
            this.subscribeToSaveResponse(
